...
require.config({
    paths: {
        ...
        helpers        : "helpers",
        constants      : "constants",
        dateFormat     : "./libs/date.format/date.format",
        d3             : "./libs/d3.v3",
        topojson       : "./libs/topojson.v0.min/index",
        jqueryBarcode  : "./libs/jquery-barcode/jquery-barcode",
...
require(["Backbone", "jQuery", "app"], function (Backbone, $, app) {
    ...
    App.render = function (data) {
        ...
        if (messageClass === "error") console.error("Error", text);
